...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        TextInputFormat.addInputPath(job, new Path("hdfs://localhost:9000/user/hadoop/out/flowcount_out"));
        // 2. 设置Mapper类
...
//        job.setNumReduceTasks(2);
        ...
        // 设置输出的路径
        TextOutputFormat.setOutputPath(job, new Path("hdfs://localhost:9000/user/hadoop/out/flowCountSort_out"));
